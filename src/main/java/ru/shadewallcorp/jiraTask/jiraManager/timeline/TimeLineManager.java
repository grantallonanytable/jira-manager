package ru.shadewallcorp.jiraTask.jiraManager.timeline;

import ru.shadewallcorp.jiraTask.jiraManager.date.DateUtil;
import ru.shadewallcorp.jiraTask.jiraManager.date.Time;
import ru.shadewallcorp.jiraTask.jiraManager.sla.*;
import ru.shadewallcorp.jiraTask.jiraManager.jira.issue.IssueDo;
import ru.shadewallcorp.jiraTask.jiraManager.jira.issue.IssueStatusDo;
import ru.shadewallcorp.jiraTask.jiraManager.jira.issue.Severity;

import java.text.ParseException;
import java.util.Date;
import java.util.List;

import static ru.shadewallcorp.jiraTask.jiraManager.jira.issue.IssueStatus.ANALYSIS;
import static ru.shadewallcorp.jiraTask.jiraManager.jira.issue.IssueStatus.CLOSED;
import static ru.shadewallcorp.jiraTask.jiraManager.jira.issue.IssueStatus.READY_FOR_DEVELOPMENT;
import static ru.shadewallcorp.jiraTask.jiraManager.jira.issue.IssueStatus.READY_TO_MERGE;
import static ru.shadewallcorp.jiraTask.jiraManager.jira.issue.IssueStatus.READY_TO_RELEASE;
import static ru.shadewallcorp.jiraTask.jiraManager.jira.issue.IssueStatus.WAITING_EXTERNAL;
import static ru.shadewallcorp.jiraTask.jiraManager.jira.issue.IssueStatus.ADD_INFO;

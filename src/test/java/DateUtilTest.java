...
import static ru.shadewallcorp.jiraTask.jiraManager.date.DateUtil.addDays;
import static ru.shadewallcorp.jiraTask.jiraManager.date.DateUtil.addHoursAndMinutes;
import static ru.shadewallcorp.jiraTask.jiraManager.date.DateUtil.addWorkDays;
import static ru.shadewallcorp.jiraTask.jiraManager.date.DateUtil.addWorkHours;
import static ru.shadewallcorp.jiraTask.jiraManager.date.DateUtil.date;
import static ru.shadewallcorp.jiraTask.jiraManager.date.DateUtil.diffDate;
import static ru.shadewallcorp.jiraTask.jiraManager.date.DateUtil.diffTime;
import static ru.shadewallcorp.jiraTask.jiraManager.date.DateUtil.diffWorkDate;
import static ru.shadewallcorp.jiraTask.jiraManager.date.DateUtil.sumTime;
import static ru.shadewallcorp.jiraTask.jiraManager.date.DateUtil.time;
...
public class DateUtilTest {
    ...
    public void testGenerateReport() throws Exception {
        ...
        ReportGenerator.saveReport("D://test.xls", rows);
    }
